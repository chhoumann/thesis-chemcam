...
This thesis aims to improve the prediction of major oxide compositions from \gls{libs} data by building on the foundation established in~\citet{p9_paper} in order to enhance model accuracy and robustness.
