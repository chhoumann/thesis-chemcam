...
In Section~\ref{sec:related-work} we review the related work of quantitative analysis in the field of \gls{libs} data analysis.
Section~\ref{sec:problem_definition} formally defines the problem addressed in this work.
Section~\ref{sec:background} provides an overview of the data used in this work, preprocessing techniques, and machine learning models and techniques used in our proposed pipeline.
In Section~\ref{sec:baseline_replica} we present a brief introduction to the \gls{moc} model and our previous work of replicating it. The results presented are used as a baseline comparison for our stacking ensemble.
Section ~\ref{sec:proposed_approach} introduces our proposed approach of addressing the problem definition, including the model and preprocessing selection, our data partitioning and cross-validation strategy, and our optimization framework.
Section~\ref{sec:methodology} introduces our experimental design and results of the experiments conducted in this work, including the results of our stacking ensemble.
Finally, Section~\ref{sec:conclusion} and Section~\ref{sec:future_work} concludes the paper by summarizing our findings and discussing the implications of our work and give suggestions for future work, respectively. 
