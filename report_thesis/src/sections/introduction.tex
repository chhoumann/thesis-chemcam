...
Leveraging the knowledge gained from the Viking missions, NASA launched the \gls{mer} mission in 2003 to further investigate whether Mars ever had the conditions to support life as we know it.
...
Thanks to its sophisticated equipment, Curiosity was quickly able to find evidence of past habitable environments on Mars based on chemical and mineral findings.\cite{marsnasagov_chemcam}
