...
For analyzing Martian geological samples, the ChemCam team currently uses the \textit{Multivariate Oxide Composition} (MOC) model\cite{cleggRecalibrationMarsScience2017}.
