...
The stacking approach demonstrated significant improvements in prediction accuracy as compared to the baseline we described in Section~\ref{sec:baseline_replica}, validating the efficacy of our methodology.
