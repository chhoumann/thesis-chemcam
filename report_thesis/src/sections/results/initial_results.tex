...
Inspecting individual model performance per oxide revealed that the best model varied depending on the oxide, highlighting the importance of evaluating model performance on a per-oxide basis and supporting our decision to pursue a stacking ensemble approach to leverage the strengths of multiple models.
