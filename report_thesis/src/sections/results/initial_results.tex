...
Hyperparameter tuning akin to the method detailed in Section~\ref{sec:optimization_framework} could be pursued, but the required computational time would be prohibitive.
