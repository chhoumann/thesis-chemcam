...
For a more detailed description of the data and the preprocessing steps, we refer the reader to \citet{p9_paper}, since the data preparation follows the same procedures detailed in that work.

Once preprocessed, the data was conventionally split into training and testing sets. 
However, as detailed in \citet{p9_paper} and \cite{cleggRecalibrationMarsScience2017}, care has to be taken in order to ensure that the training set is constructed such that it has sufficient samples containing extreme values.
