...
Additionally, discovery phase also included investigating various data preprocessing techniques that worked well in conjunction with these models. % Perhaps add some details along with sources from the literature and also show some results
...
% perhaps add something about the fact that we were indifferent to univariate vs multivariate models. We just wanted to find the best.
