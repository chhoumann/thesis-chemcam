...
Consequently, the \gls{ccs} data for each sample forms a high-dimensional \texttt{Intensity Tensor} \texttt{I} (Tensor \ref{matrix:intensity}) with dimensions $5 \times 50 \times 6144$.
