...
For each sample, five \gls{ccs} datasets are collected by shooting 50 times at the sample from different locations and processing the raw spectral readings\cite{wiensPreflightCalibrationInitial2013}.
Consequently, the \gls{ccs} data for each sample forms a substantial high-dimensional matrix with dimensions $5 \times 50 \times 6144$.
