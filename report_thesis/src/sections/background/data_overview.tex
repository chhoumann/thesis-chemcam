...
The \gls{ccs} data will at this stage have negative values and noise at the edges of the spectrometers.
How these are handled is described in Section~\ref{sec:data-preparation}.
Once prepared, the \gls{ccs} data can now be used for preprocessing and model training.