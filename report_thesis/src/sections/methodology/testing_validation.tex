...
Notably, the bimodal distribution of \ce{SiO2} concentrations and the skewed distributions of \ce{FeO_T} and \ce{CaO} highlight the presence of extreme values.
These distributions confirm that certain oxide concentrations are significantly overrepresented or underrepresented, further complicating the model training process.
