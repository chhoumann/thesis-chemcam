...
Figures \ref{fig:histogram_grid_plot}, \ref{fig:histogram_kde_plot}, and \ref{fig:original_and_post_fold_plot} provide visual insights into the distribution of \ce{SiO_2} concentrations across different folds used in our custom k-fold data partitioning procedure.
