...
Furthermore, the limited availability we mention in Section~\ref{sec:problem_definition} of data poses another significant challenge.
...
\begin{figure*}[h!]
    ...
    \caption{Distributions of various oxide concentrations in the dataset. The histograms show the frequency of concentration values for \ce{SiO2}, \ce{TiO2}, \ce{Al2O3}, \ce{FeOT}, \ce{MgO}, \ce{CaO}, \ce{Na2O}, and \ce{K2O}.}
...
Notably, the bimodal distribution of \ce{SiO2} concentrations and the skewed distributions of \ce{FeOT} and \ce{CaO} highlight the presence of extreme values.
