...
While random forests use bootstrap sampling to create diverse training sets, \gls{etr} goes further by selecting a random subset of features at each node and determining split points randomly within the range of those features.
...
As a tradeoff, ETR is less interpretable than a single decision tree, as the added randomness can introduce more bias than RF.
