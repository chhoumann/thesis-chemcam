...
Once optimal splits based on some evaluation metric, are identified, the tree is constructed by repeatedly partitioning the data until a stopping criterion is met.
