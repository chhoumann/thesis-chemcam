...
To minimize errors, gradient descent is used, effectively reducing errors by moving in the direction of the steepest descent as dictated by the gradient of the loss function~\cite{gradientLossFunction}.
