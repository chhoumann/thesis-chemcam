...
Robust scaler is a normalization technique that removes the median and scales the data according to the quantile range.
...
This technique is advantageous because it does not rely on the mean and variance of the data, which can be affected by outliers.
Consequently, the robust scaler is a preferable choice when dealing with datasets that contain outliers~\cite{Vasques2024}.
