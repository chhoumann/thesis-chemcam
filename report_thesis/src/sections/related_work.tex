...
Predicting major oxide compositions from \gls{libs} data presents multifaceted challenges, such as high dimensionality, data complexity, and the need for effective preprocessing and feature engineering. 
These issues represent important obstacles to overcome for advancing \gls{libs} analytics, particularly in applications like planetary exploration and geochemical analysis.
...
This review adopts a thematic taxonomy to structure to highlight existing research in this field. 
The main themes covered include machine learning models, hybrid and domain-knowledge-driven approaches, deep learning techniques, preprocessing and feature engineering, and dimensionality reduction. 
