...
\citet{shi_svr_libs_2015} compared the performance of \gls{svr} and \gls{plsr} for quantitative analysis of major elements (Si, Ca, Mg, Fe, Al) in sedimentary rock samples using \gls{libs} data.
They optimized the SVR model parameters using a genetic algorithm and cross-validation, selecting 20 characteristic emission lines as input features without dimensionality reduction.
