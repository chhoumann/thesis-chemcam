\subsection{Custom K-Fold Cross-Validation}\label{subsec:custom-k-fold-cross-val}%\label{subsec:validation_testing_procedures}
This section further motivates the need for a custom k-fold cross-validation procedure, followed by a detailed description of the dataset partitioning process and the algorithm devised to solve this problem.
Finally, we outline the evaluation metrics used to assess the performance of our models.
