...
We start by presenting the data partitioning procedure we use to partition our dataset into training, validation, and testing sets.
Then we present the evaluation metrics we use to evaluate the performance of our models.
