...
Having established the validation and testing procedures, as well as, the evaluation metrics in our experiments, this section will detail our approach to model and preprocessing selection.
