...
A fundamental criteria for an exploration and optimization procedure is the alignment with our goals of generalization, robustness, and accuracy, as outlined in Section~\ref{sec:problem_definition}.
To achieve this, the search process should be guided by an ojective function achieves thse goals.
