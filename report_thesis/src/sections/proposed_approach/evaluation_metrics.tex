...
As mentioned in Section~\ref{subsubsec:problem_evaluation_metrics}, the performance of the models is quantitatively assessed using the \gls{rmse} and the standard deviation of the residuals.
