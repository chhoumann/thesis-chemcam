...
% \foreach \method in {elasticnet, enet_a_01, svr} {
%   \foreach \oxide in {SiO2, TiO2, Al2O3, FeOT, MgO, CaO, Na2O, K2O} {
%       % images/plots/one_to_one/\method/\oxide.png
%   }
% }
...
%                 \centering
%                 \includegraphics[width=\textwidth]{images/one_to_one/\method/\oxide.png}
%                 \caption{\oxide}
%                 \label{fig:\method_\oxide}
%             \end{subfigure}
%             \ifnum\i=4 \columnbreak \fi
%         }
%         \caption{\method}
%         \label{fig:\method}
%     \end{figure*}
