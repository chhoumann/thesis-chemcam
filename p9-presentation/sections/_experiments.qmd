...
**Table 4.2**
The previous results then led us to wonder how much of an effect outlier detection would have with this aggregated dataset. Since the signal in data was likely being obscured, we reasoned that this would also make it easier to pick out any outliers. 
