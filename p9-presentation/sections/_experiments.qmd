...
The implicit evaluation of the PLS-SM is interesting since if we did not see a big in RMSE between our own and clegg et. al's, then that would call into question of doing outlier removal at all for PLS-SM.
