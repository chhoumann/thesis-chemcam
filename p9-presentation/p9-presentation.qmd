...
## Multivariate Oxide Compositions
::: {style="width=100%;"}
![](/static/methodology/pipeline.png){fig-align="center" width="35%"}
:::
::: {data-id="moc-box"}
<div style="position: absolute; top: 75.5%; left: 40.9%; width: 18%; height: 21%; border: 2px solid red; box-sizing: border-box; pointer-events: none;"></div>
:::
