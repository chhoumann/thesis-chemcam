...
However, it does not require the components to be perpendicular to each other; instead, it seeks components that are statistically independent.<br>
<br>
The result of running JADE 
:::
