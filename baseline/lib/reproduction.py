...
training_info = {
    "SiO2": {
        "Full": {"range": (0, 100), "n_components": 9, "normalization": 3},
        "Low": {"range": (0, 50), "n_components": 13, "normalization": 3},
        "Mid": {"range": (30, 70), "n_components": 10, "normalization": 3},
        "High": {"range": (60, 100), "n_components": 6, "normalization": 1},
    },
    "TiO2": {
        "Full": {"range": (0, 100), "n_components": 6, "normalization": 3},
        "Low": {"range": (0, 2), "n_components": 5, "normalization": 1},
        "Mid": {"range": (1, 5), "n_components": 4, "normalization": 1},
        "High": {"range": (3, 100), "n_components": 5, "normalization": 3},
    },
    "Al2O3": {
        "Full": {"range": (0, 100), "n_components": 7, "normalization": 1},
        "Low": {"range": (0, 12), "n_components": 9, "normalization": 1},
        "Mid": {"range": (10, 25), "n_components": 8, "normalization": 1},
        "High": {"range": (20, 100), "n_components": 4, "normalization": 1},
    },
    "FeOT": {
        "Full": {"range": (0, 100), "n_components": 6, "normalization": 1},
        "Low": {"range": (0, 15), "n_components": 3, "normalization": 3},
        "Mid": {"range": (5, 25), "n_components": 10, "normalization": 1},
        "High": {"range": (15, 100), "n_components": 5, "normalization": 1},
    },
    "MgO": {
        "Full": {"range": (0, 100), "n_components": 7, "normalization": 3},
        "Low": {"range": (0, 3.5), "n_components": 5, "normalization": 1},
        "Mid": {"range": (0, 20), "n_components": 7, "normalization": 1},
        "High": {"range": (8, 100), "n_components": 7, "normalization": 3},
    },
    "CaO": {
        "Full": {"range": (0, 42), "n_components": 8, "normalization": 3},
        "Low": {"range": (0, 7), "n_components": 13, "normalization": 3},
        "Mid": {"range": (0, 15), "n_components": 11, "normalization": 3},
        "High": {"range": (30, 100), "n_components": 7, "normalization": 3},
    },
    "Na2O": {
        "Full": {"range": (0, 100), "n_components": 7, "normalization": 1},
...
weighted_sum_oxide_percentages = {
    "Al2O3": {"PLS1-SM": 30, "ICA": 70},
    "FeOT": {"PLS1-SM": 50, "ICA": 50},
    ...
    "TiO2": {"PLS1-SM": 40, "ICA": 60},
    "MgO": {"PLS1-SM": 60, "ICA": 40},
    "CaO": {"PLS1-SM": 30, "ICA": 70},
}
