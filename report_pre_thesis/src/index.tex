...
\section{Definition}
Given a set \(E\) of the eight major oxides detectable using LIBS, \(E = \{SiO_2, TiO_2, Al_2 O_3, FeOT, MgO, CaO, Na_2O, K_2O\}\), and considering \(\mathcal{P}(E)\) as the power set of \(E\) which represents all possible combinations of these oxides, we define \(K \subseteq \mathcal{P}(E) \) as the set of compositions of these oxides that can be subjected to LIBS.
