...
This is done by taking a weighted average of the two models, where the weights for each oxide are determined by which technique is better suited for the given oxide.
