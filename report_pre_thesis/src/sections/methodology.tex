...
As mentioned in Section~\ref{sec:data_overview}, the edges of the spectral regions contain noise, so we apply masking to the data to zero out these regions.
...
We then apply masking to the data to zero out the same regions as in the PLS1-SM phase.
