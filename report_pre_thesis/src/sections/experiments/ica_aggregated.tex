...
\hline                    
\ce{SiO2}  & 10.68        & 8.64               & 12.01             & \textbf{9.47} \\
\ce{TiO2}  & 0.63         & 0.53               & 0.60              & \textbf{0.48} \\
\ce{Al2O3} & 5.55         & 3.69               & 4.81              & \textbf{2.66} \\
\ce{FeO_T} & 8.30         & 7.07               & 8.56              & \textbf{7.05} \\
\ce{MgO}   & 2.90         & 2.10               & \textbf{2.51}     & 2.83 \\
\ce{CaO}   & 3.52         & 4.00               & 3.71              & \textbf{1.90} \\
\ce{Na2O}  & 1.72         & 1.45               & \textbf{1.41}     & 1.60 \\
\ce{K2O}   & 1.37         & 1.15               & 1.51              & \textbf{1.08} \\
\hline
\end{tabular}
