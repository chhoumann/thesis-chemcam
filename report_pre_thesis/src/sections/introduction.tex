...
\textit{In this work, we aim to solve the problem of identifying issues with the components of the current MOC model that limit its predictive accuracy and robustness against matrix effects.}
We then then proposing improvements to the model to address these issues.
