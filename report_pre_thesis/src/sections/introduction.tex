...
Its primary functions include detecting geological features that are not visible to the rover's cameras and leveraging its speed for efficient exploration.
