...
Despite its utility, the domain experts from the ChemCam team have observed that the existing MOC model exhibits limitations in both predictive accuracy and robustness.
