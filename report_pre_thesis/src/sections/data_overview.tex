...
\begin{figure}[ht]
    ...
    \begin{forest}
        for tree={
            ...
            grow'=0,
            child anchor=west,
            parent anchor=southTo calibrate,
            anchor=west,
            calign=first,
            inner xsep=7pt,
            edge path={
...
% For calibrating the ChemCam instrument, the ChemCam team has collected a large amount of data from a variety of samples on Earth, consisting of 408 pressed powder samples whose chemical compositions are independently measured\cite{cleggRecalibrationMarsScience2017}.
