...
The ChemCam calibration data is stored in a directory structure as shown in Figure~\ref{fig:directory_structure}.
...
For each major oxide, the ground truth data contains how much of the oxide is present in the sample as a percentage.