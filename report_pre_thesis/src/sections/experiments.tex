...
% - We've now established a baseline for comparison with the original MOC pipeline and as a basis for assessing experimental results.
% - We now describe the experiments we have conducted to evaluate the performance of each of the components in the pipeline.
% - We start by describing the baseline we have established.
% - Then, we describe the experiments we have conducted.

% ## From sec:methodology
